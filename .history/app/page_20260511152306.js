...
export default function Page() {
  ...
  return (
    <main className="min-h-screen bg-[#0f172a] overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-10">
            ...
            <div className="space-y-8">
              ...
              {/* Map */}
              <div className="rounded-3xl overflow-hidden border border-[#e5e7eb] shadow-sm">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2888.3964635138415!2d55.13900127593674!3d25.080362677790904!2m3!1f0!2f0!3f0!"
                  width="100%"
                  height="300"
                  allowFullScreen=""
                  loading="lazy"
      ...
      {/* Footer */}
      <footer className="bg-[#0f172a] text-[#f8fafc] pt-20 px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 pb-16 border-b border-white/10">
            ...
            <div>
              ...
              {/* Socials */}
              <div className="flex gap-4">
                <a className="text-[#9ca3af] hover:text-[#d4af37] transition">
                  Facebook
                </a>
                <a className="text-[#9ca3af] hover:text-[#d4af37] transition">
                  Instagram
            ...
            <div>
              ...
              <form onSubmit={handleSubscribe} className="space-y-3">
                <input
                  ...
                  placeholder="Enter your email"
                  className="w-full px-4 py-3 rounded-xl bg-[#111827] border border-white/10 text-white outline-none focus:border-[#d4af37] transition"
                />

                <button
                  type="submit"
                  className="w-full bg-[#d4af37] text-[#0f172a] py-3 rounded-xl font-semibold hover:bg-[#c59b24] hover:scale-105 transition duration-300"
                >
                  Subscribe
                </button>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between py-6 text-[#9ca3af] text-sm gap-4">
