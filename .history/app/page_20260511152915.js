...
export default function Page() {
  ...
  const handleSubscribe = (e) => {
    ...
    // Show MUI Snackbar instead of alert
    setOpen(true);
    setEmail("");
  };
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
              ...
              {["Home", "Rooms", "Booking", "About", "FAQ", "Contact"].map(
                (item, i) => (
                  <li key={i}>
                    <a
                      href="#"
                      className="text-[#9ca3af] hover:text-[#d4af37] transition duration-300"
                    >
                      {item}
                    </a>
                  </li>
          ...
          <div>
            ...
            <p className="text-sm text-[#9ca3af] mb-3">
              Get exclusive offers & luxury deals.
            </p>
            ...
            <form onSubmit={handleSubscribe} className="flex flex-col gap-3">
              ...
              <button
                type="submit"
                className="bg-[#d4af37] text-black font-semibold py-2 rounded-md hover:bg-yellow-500 transition duration-300"
              >
                Subscribe
              </button>
            </form>
