...
export default function Page() {
  ...
  const stats = [
    { number: "10000+", label: "Happy Guests" },
    ...
    <main className="min-h-screen bg-[#0f172a] overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
            ...
            <div className="hidden lg:block">
              <Link href="#booking">
                <button className="bg-[#d4af37] text-[#0f172a] cursor-pointer px-6 py-3 rounded-full font-semibold shadow-lg hover:bg-[#c59b24] hover:scale-105 transition-all duration-300">
                  Book Now
                </button>
              </Link>
            </div>
      ...
      >
        ...
        <div className="flex flex-col items-center justify-center h-[80vh] gap-8">
          ...
          <button className="mt-6 bg-[#d4af37] cursor-pointer text-[#0f172a] px-8 py-4 rounded-full font-semibold shadow-xl hover:bg-[#c59b24] hover:scale-105 transition-all duration-300">
            Book Now
          </button>
        </div>
      </div>
      ...
      {/* About Section */}
      <section id="about" className="bg-[#f8fafc] py-24 px-6 lg:px-8">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
                {stats.map((stat, index) => (
                  <div
                    key={index}
                    className="bg-white rounded-2xl p-4 sm:p-5 lg:p-6 shadow-sm border border-gray-100 hover:shadow-xl transition-all duration-300 text-center"
                  >
      ...
      {/* Booking Section */}
      <section id="booking" className="bg-[#f8fafc] py-24 px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
            ...
            <div className="lg:col-span-2 bg-white rounded-3xl shadow-xl p-8 md:p-10 border border-gray-100">
              <form onSubmit={handleSubmit}>
                ...
                <div className="mt-8">
                  <button
                    type="submit"
                    className="w-full md:w-auto cursor-pointer bg-[#d4af37] text-[#0f172a] px-10 py-4 rounded-full font-semibold shadow-lg hover:bg-[#c59b24] hover:scale-105 transition-all duration-300"
                  >
                    Confirm Booking
                  </button>
                </div>
      ...
      <section className="bg-[#f8fafc] py-24 px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
            ...
            {faqs.map((faq, index) => (
              ...
              >
                <button
                  ...
                  className="w-full flex items-center justify-between cursor-pointer text-left px-6 py-5"
                >
                  <h3
          ...
          <div className="mt-16 bg-white border border-[#e5e7eb] rounded-3xl p-8 text-center shadow-sm">
            ...
            <button className="bg-[#d4af37] text-[#0f172a] px-8 py-4 cursor-pointer rounded-full font-semibold shadow-lg hover:bg-[#c59b24] hover:scale-105 transition-all duration-300">
              Contact Support
            </button>
          </div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-10">
            <div className="bg-[#f8fafc] rounded-3xl p-8 md:p-10 border border-[#e5e7eb] shadow-sm">
              ...
              <form onSubmit={handleContactSubmit}>
                ...
                <button
                  type="submit"
                  className="mt-8 w-full md:w-auto bg-[#d4af37] cursor-pointer text-[#0f172a] px-10 py-4 rounded-full font-semibold shadow-lg hover:bg-[#c59b24] hover:scale-105 transition-all duration-300"
                >
                  Send Message
                </button>
              </form>
      ...
      <section className="bg-[#f8fafc] py-24 px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mt-20 text-center bg-white border border-[#e5e7eb] rounded-3xl p-10 shadow-sm">
            ...
            <Link href="#booking">
              <button className="bg-[#d4af37] text-[#0f172a] px-10 py-4 cursor-pointer rounded-full font-semibold shadow-lg hover:bg-[#c59b24] hover:scale-105 transition-all duration-300">
                Book Your Stay
              </button>
            </Link>
          </div>
      ...
      >
        <div className="max-w-5xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 mt-3 text-sm md:text-base">
              Understand our cancellation rules before making changes to your booking.
            </p>
          </div>
          ...
          <div className="bg-[#f8fafc] border border-gray-200 rounded-2xl shadow-sm p-6 md:p-10 space-y-8">
            ...
            <div>
              ...
              <p className="text-gray-600 leading-7 text-sm md:text-base">
                Free cancellation is available if requested within the allowed time period before check-in.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-600 leading-7 text-sm md:text-base">
                Cancellations made close to the check-in date may result in partial or no refund.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-600 leading-7 text-sm md:text-base">
                If a guest does not arrive on the booking date, it will be treated as a no-show and no refund will be issued.
              </p>
            </div>
            ...
            <div>
              <h3 className="text-xl font-semibold text-[#0f172a] mb-2">
                5. Modification Instead of Cancellation
              </h3>
              <p className="text-gray-600 leading-7 text-sm md:text-base">
                In some cases, booking modifications are allowed instead of cancellation, subject to availability.
              </p>
            </div>
...
<div>
  ...
  <ul className="space-y-2 text-sm text-[#9ca3af]">
    ...
    <li>
      <a href="/terms-and-conditions" className="hover:text-[#d4af37] transition">
        Terms & Conditions
      </a>
    </li>

    <li>
      <a href="/booking-policy" className="hover:text-[#d4af37] transition">
        Booking Policy
      </a>
    </li>

    <li>
      <a href="/cancellation-policy" className="hover:text-[#d4af37] transition">
        Cancellation Policy
      </a>
    </li>

    <li>
      <a href="/refund-policy" className="hover:text-[#d4af37] transition">
        Refund Policy
      </a>
    </li>
