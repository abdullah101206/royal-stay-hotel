      ...
      <section className="relative flex items-center justify-center min-h-screen px-6">
        ...
        <div className="relative z-10 max-w-4xl text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-5">
            ...
            <button className="bg-[#d4af37] cursor-pointer text-[#0f172a] px-8 py-4 rounded-full font-semibold shadow-2xl hover:bg-[#c59b24] hover:scale-105 transition-all duration-300">
              Book Your Room
            </button>

            <button className="border border-white/30 cursor-pointer text-white px-8 py-4 rounded-full font-semibold hover:border-[#d4af37] hover:text-[#d4af37] transition-all duration-300">
              Explore Rooms
            </button>
          </div>
        </div>
