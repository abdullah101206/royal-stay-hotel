                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <label className="flex items-start gap-3 cursor-pointer">
                        ...
                        <p className="text-sm text-gray-500 leading-relaxed">
                            ...
                            <span className="text-[#d4af37] hover:text-yellow-600 transition font-medium">
                                Terms & Conditions
                            </span>
                        </p>
                    </label>
                    ...
                    <button
                        type="button"
                        className="w-full border border-[#e5e7eb] py-3 rounded-xl font-medium text-[#1f2937] hover:bg-gray-50 transition-all duration-300"
                    >
